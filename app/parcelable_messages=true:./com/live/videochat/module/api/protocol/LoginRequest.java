...
// Source file: VCProto.proto at 105:1
...
public final class LoginRequest extends Message<LoginRequest, LoginRequest.Builder> {
  ...
  /**
   * Facebook 或者 Google提供的第三方认证凭证（确认）
   */
  @WireField(
      tag = 3,
  ...
  public LoginRequest(ClientInfo clientInfo, DeviceInfo deviceInfo, String openId, String token, Integer channel) {
    this(clientInfo, deviceInfo, openId, token, channel, ByteString.EMPTY);
  }

  public LoginRequest(ClientInfo clientInfo, DeviceInfo deviceInfo, String openId, String token, Integer channel, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<LoginRequest, Builder> {
    ...
    public LoginRequest build() {
      ...
      return new LoginRequest(clientInfo, deviceInfo, openId, token, channel, super.buildUnknownFields());
    }
  }
