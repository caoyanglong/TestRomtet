...
// Source file: VCProto.proto at 26:1
 ...
 * 用户身份信息
 */
public final class ClientTest extends Message<ClientTest, ClientTest.Builder> {
  public static final ProtoAdapter<ClientTest> ADAPTER = new ProtoAdapter_ClientTest();
  ...
  public ClientTest(String pkgName, String versionName, Integer versionCode, String channel, String signatureMD5, String installerPackageName, Integer userGroupId, String channelNetwork, String channelCampaign, String channelAdGroup) {
  ...
  public ClientTest(String pkgName, String versionName, Integer versionCode, String channel, String signatureMD5, String installerPackageName, Integer userGroupId, String channelNetwork, String channelCampaign, String channelAdGroup, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ClientTest)) return false;
    ClientTest o = (ClientTest) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "ClientTest{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<ClientTest, Builder> {
    ...
    public ClientTest build() {
      ...
      return new ClientTest(pkgName, versionName, versionCode, channel, signatureMD5, installerPackageName, userGroupId, channelNetwork, channelCampaign, channelAdGroup, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_ClientTest extends ProtoAdapter<ClientTest> {
    ProtoAdapter_ClientTest() {
      super(FieldEncoding.LENGTH_DELIMITED, ClientTest.class);
    }

    @Override
    public int encodedSize(ClientTest value) {
    ...
    @Override
    public void encode(ProtoWriter writer, ClientTest value) throws IOException {
    ...
    @Override
    public ClientTest decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public ClientTest redact(ClientTest value) {
