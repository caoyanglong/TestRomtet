...
// Source file: protobuf.proto at 5:1
...
public final class Person extends Message<Person, Person.Builder> {
  ...
  @WireField(
      tag = 4,
      adapter = "com.giousa.protobufdemo.model.Person$PhoneNumber#ADAPTER",
  ...
  public static final class PhoneNumber extends Message<PhoneNumber, PhoneNumber.Builder> {
    ...
    @WireField(
        tag = 2,
        adapter = "com.giousa.protobufdemo.model.Person$PhoneType#ADAPTER"
    )
  ...
  public static final class CountryInfo extends Message<CountryInfo, CountryInfo.Builder> {
    ...
    public CountryInfo(String name, String code, Integer number) {
      this(name, code, number, ByteString.EMPTY);
    }

    public CountryInfo(String name, String code, Integer number, ByteString unknownFields) {
      super(ADAPTER, unknownFields);
      this.name = name;
      this.code = code;
      this.number = number;
    ...
    public static final class Builder extends Message.Builder<CountryInfo, Builder> {
      ...
      public CountryInfo build() {
        ...
        return new CountryInfo(name, code, number, super.buildUnknownFields());
      }
    }

    private static final class ProtoAdapter_CountryInfo extends ProtoAdapter<CountryInfo> {
      ProtoAdapter_CountryInfo() {
